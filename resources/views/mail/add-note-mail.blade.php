                ...
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>Not Ekleme Duyurusu</strong>
                        </div>
                        <div style="padding-bottom: 30px">Başkanım <a
                                href="{{ url('/admin/project/' . $note->project->slug . '/notes') }}"
                                style="color: #04C8C8">{{ $note->project->title }}</a> projesine
                            {{ $note->title }} notu eklendi.
                        </div>
