                ...
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px; font-size: 17px;">
                            <strong>Proje Atama Duyurusu</strong>
                        </div>
                        <div style="padding-bottom: 30px">Merhaba, {{ $appoint->user->name }} <a
                                href="{{ url('/project/' . $appoint->project->slug) }}"
                                style="color: #04C8C8">{{ $appoint->project->title }}</a>
                            projesine
                            atandınız. Proje detayları için proje linkine tıklayınız</div>
                        ...
                        <!--end:Email content-->
                        <div style="padding-bottom: 10px">İyi çalışmalar, Markapress
                            <br> Ekibi.
            <tr>
                <td align="center" valign="center"
                    style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
                    <p>Copyright ©
                        <a href="{{ url('') }}" rel="noopener" target="_blank">Markapress Proje Takip
                            Sistemi</a>.
                    </p>
                </td>
            </tr></br>
